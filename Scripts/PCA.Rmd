...
# I. Load in the functional connectivity and dissimilarity data
...
# II. Conduct principal components analysis
...
```{r}
plot(1:length(funcPCA$sdev), cumsum(funcPCA$sdev^2/2346), ylab = '% Variance explained', 
...
plot(1:length(distPCA$sdev), cumsum(distPCA$sdev^2/2346), ylab = '% Variance explained', 
     xlab = '# of principal of components',
...
points(scale(distPCA$x[,1]),scale(distPCA$x[,2]), 
       col = 1+(as.numeric(as.factor(corPCAlbl$GROUP))^2),
